    ...
    <div className="bg-soft-black text-off-white min-h-screen">
      ...
      <section className="h-screen flex flex-col justify-center items-center text-center px-4 relative overflow-hidden">
        <div className="text-center mb-6">
          <h2 className="text-4xl font-bold mb-4 text-off-white">About The Weeknd</h2>
        ...
        <div className="text-center space-y-6">
          ...
          <div className="pt-10">
            <p className="text-2xl font-semibold mb-3">Listen to The Weeknd</p>
            ...
            <div className="flex justify-center space-x-4">
              <a
                ...
                className="w-48 backdrop-blur-[1px] bg-white/10 text-off-white px-5 py-2 rounded-full font-semibold shadow-lg border border-white/5 hover:bg-white/20 hover:border-green-500 hover:text-green-500 transition focus:outline-none focus:ring-2 focus:ring-green-500 focus:ring-opacity-50 flex items-center justify-center space-x-2"
              >
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="w-48 backdrop-blur-[1px] bg-white/10 text-off-white px-5 py-2 rounded-full font-semibold shadow-lg border border-white/5 hover:bg-white/20 hover:border-red-500 hover:text-red-500 transition focus:outline-none focus:ring-2 focus:ring-red-500 focus:ring-opacity-50 flex items-center justify-center space-x-2"
              >
                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"><path fill="currentColor" d="M12 0C5.376 0 0 5.376 0 12s5.376 12 12 12s12-5.376 12-12S18.624 0 12 0m0 19.104c-3.924 0-7.104-3.18-7.104-7.104S8.076 4.896 12 4.896s7.104 3.18 7.104 7.104s-3.18 7.104-7.104 7.104m0-13.332c-3.432 0-6.228 2.796-6.228 6.228S8.568 18.228 12 18.228s6.228-2.796 6.228-6.228S15.432 5.772 12 5.772M9.684 15.54V8.46L15.816 12z"/></svg>
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="w-48 backdrop-blur-[1px] bg-white/10 text-off-white px-5 py-2 rounded-full font-semibold shadow-lg border border-white/5 hover:bg-white/20 hover:border-cyan-400 hover:text-cyan-400 transition focus:outline-none focus:ring-2 focus:ring-cyan-400 focus:ring-opacity-50 flex items-center justify-center space-x-2"
              >
                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"><path fill="currentColor" d="M12.012 3.992L8.008 7.996L4.004 3.992L0 7.996L4.004 12l4.004-4.004L12.012 12l-4.004 4.004l4.004 4.004l4.004-4.004L12.012 12l4.004-4.004zm4.03 4.004l3.979-3.979L24 7.996l-3.979 3.979z"/></svg>
                <span>Tidal</span>
              </a>
            </div>
          </div>
